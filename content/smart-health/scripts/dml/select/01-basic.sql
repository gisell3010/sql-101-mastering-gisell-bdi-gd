-- Mostrar el nombre completo, el correo y el genero de los pacientes nacidos entre
-- 1990 y 1993. Listar las 5 primeras personas ordenadas alfabeticamente por 
-- su primer nombre.

-- FROM: Pacientes -> smat_health.patients;
-- from, condiciones, ordenamiento, limites
SELECT 
...
-- Modificar consulta anterior, personas nacidas entre 2005 y 2008 y que el genero sea masculino o femenino, 
-- Ordenar descendentemente por primer apellido, mostrar los primeros 8 resultados
SELECT 
    first_name||' '||first_surname AS fullname,
    gender,
    email,
...
LIMIT 5;
-- Expresiones regulares(por ejmplo, slice)

-- Mostrar nombre completo, genero, tipo identificacion, numero de documento y la fecha de registro, de los 5 pacientes mas jovenes, que tengan estado activo.
--(CURRENT_DATE - birth_date) AS d
--p.birth_date
-- COALESCE(para cuando hayan campos vacios)
...
--Mostrar las 10 primeras citas, que se hicieron entre el 25 de Febrero del 2025 y el 28 de Octubre del 2025.
SELECT 
    appointment_type,
    appointment_date
...
--Mostrar los datos del numero de telefono, para los siguientes pacientes. Filtrar por el campo numero_documento['30451580','1006631391','1009149871','1298083','1004928596','1008188849','1607132','30470003']
SELECT 
    d.phone_number,
    p.document_number

FROM smart_health.patients AS p JOIN smart_health.patient_phones AS d ON d.patient_id = p.patient_id
WHERE p.document_number IN ('30451580','1006631391','1009149871','1298083','1004928596','1008188849','1607132','30470003');
